    ...
    projects: [
      {
        ...
        description: {
          en: "Alive: a application for AIA’s customers to manage their wellness and well-being. Built using Expo for Frontend and Spring Boot for Backend. Uses AI-assisted development with SpecKit for a spec-driven workflow.",
          th: "Alive: แอปพลิเคชันสำหรับลูกค้า AIA เพื่อดูแลสุขภาพและความเป็นอยู่ที่ดี พัฒนาด้วย Expo สำหรับ Frontend และ Spring Boot สำหรับ Backend ใช้ AI ช่วยพัฒนาร่วมกับ SpecKit ในกระบวนการพัฒนาแบบขับเคลื่อนด้วยข้อกำหนด (spec-driven development)",
          sv: "Alive: En applikation för AIA:s kunder för att hantera hälsa och välmående. Byggd med Expo för Frontend och Spring Boot för Backend. Använder AI-assisterad utveckling med SpecKit för ett specifikationsdrivet arbetsflöde.",
          ja: "Alive: AIAのお客様が健康やウェルビーイングを管理するためのアプリケーション。FrontendはExpo、BackendはSpring Bootを使用。 SpecKitを用いた仕様駆動開発にAIを活用。",
          zh: "Alive：AIA 客户用于管理健康和生活品质的应用程序。Frontend 使用 Expo，Backend 使用 Spring Boot 开发。 使用 AI 辅助开发，并通过 SpecKit 实践规格驱动开发。",
        },
      },
    ],
  },
