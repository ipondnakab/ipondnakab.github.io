...
var _getMaximum = _interopRequireDefault(require("./getMaximum"));
...
var makeChartConfig = function makeChartConfig(data, ellipsized) {
  ...
  var maxValue = (0, _getMaximum["default"])(data);
  var maxKeyLen = Math.max.apply(Math, Object.keys(ellipsized).map(function (key) {
    return key.length;
  }));
